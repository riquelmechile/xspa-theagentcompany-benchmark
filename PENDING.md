...
- **V7:** complete. The executable three-scenario campaign was frozen before outcomes and then executed once unchanged: DIRECT 0/3 shared-oracle passes, XANXITOSPA 3/3. Deterministic mechanism evidence only; no sampling p-value.
...
3. **DONE:** V7 executed once from the frozen manifest. Raw outcomes are preserved under `results/v7/`; no negative outcome was retried and no sampling p-value is reported.
